...
def wishme():
    ...
    if hour >= 0 and hour < 12:
        ...
        speak("Good Morning")
        speak(
            f"I am chelsea Sir. It is {watch} and the time is {tt} . Please tell me how can i help you?")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        elif 'I am fine' in query or " I am doing good" in query or 'I am doing great' in query or ' I am well' in query:
            speak("It's good to know that your fine")

        elif 'not fine' in query or 'not doing fine' in query or 'not doing well' in query:
            speak("why Sir?")
            takeCommand().lower
            speak("I hope you will get through it")
